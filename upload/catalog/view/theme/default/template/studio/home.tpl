...
<script type="text/javascript"> 
	...
	{					
		...
		<?php if($opentshirts_video_tutorial_embed) { ?>
...
<?php if($opentshirts_video_tutorial_embed) { ?>
	<div id="popup_video" style="display:none;">
		<div id="html_video_container"><?php echo html_entity_decode($opentshirts_video_tutorial_embed); ?></div>
	</div>
		...
		$(function() {
			$( "#popup_video" ).dialog({
				...
				open: function(event, ui) {
					$("#html_video_container").html('<?php echo html_entity_decode($opentshirts_video_tutorial_embed); ?>');
