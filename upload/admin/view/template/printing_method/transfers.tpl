			...
			<div class="tab-content">
				<div id="tab-data" class="tab-pane active">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select id="input-status" name="data[transfers_status]" class="form-control">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" id="input-sort_order" name="data[transfers_sort_order]" value="<?php echo $data['transfers_sort_order']; ?>" size="1" class="form-control" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea id="input-description" name="data[transfers_description]" class="form-control"><?php echo $data['transfers_description']; ?></textarea>
						</div>
					</div>
				</div>
				<?php foreach ( $extra_tabs as $extra_tab ) { ?>
