					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" name="filter_id_font" value="<?php echo $filter_id_font; ?>" placeholder="<?php echo $entry_id; ?>" id="input-id" class="form-control" />
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<td class="text-right"><?php echo $column_id_font; ?></td>
									<td class="text-left">
										<?php if ($sort == 'f.name') { ?>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-right"><?php echo $font['id_font']; ?></td>
									<td class="text-left"><?php echo $font['name']; ?></td>
									<td class="text-left"><?php echo $font['status']; ?></td>
									<td class="text-left">
										<ul>
											<?php foreach ($font['categories'] as $category) { ?>
									...
									<td class="text-left">
										<ul>
											<?php foreach ($font['keywords'] as $keyword) { ?>
											<li><?php echo $keyword; ?></li>
											<?php } ?>
										</ul>
									</td>
									<td align="text-center" valign="middle"><img src="<?php echo $font['thumb']; ?>" /></td>
									<td class="text-right"><?php echo $font['date_added']; ?></td>
									<td class="right">
										<a href="<?php echo $font['edit']['href']; ?>" data-toggle="tooltip" title="<?php echo $font['edit']['text']; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
									</td>
								</tr>
								<?php } ?>
								<?php } else { ?>
