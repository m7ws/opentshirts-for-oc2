						...
						<table class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<td class="text-left" width="100%"><?php echo $column_name; ?></td>
							...
							<tbody>
								...
								<tr>
									<td class="text-center">
										...
										<input type="checkbox" name="selected[]" value="<?php echo $category['id_category']; ?>" checked="checked" />
										<?php } else { ?>
										<input type="checkbox" name="selected[]" value="<?php echo $category['id_category']; ?>" />
										<?php } ?>
									</td>
									<td class="text-left"><?php echo $category['description']; ?></td>
									<td class="text-right">
										<a href="<?php echo $category['edit']['href']; ?>" data-toggle="tooltip" title="<?php echo $category['edit']['text']; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
									</td>
								</tr>
								<?php } ?>
								<?php } else { ?>
