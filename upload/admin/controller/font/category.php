...
class ControllerFontCategory extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('font/category', 'token=' . $this->session->data['token'], 'SSL')); 
		}
	...
	private function getList() {
		...
		$data['categories'] = $this->recursiveCategories($this->model_font_category->getCategoriesByParentId());
		
		$data['delete'] = $this->url->link('font/category/delete', 'token=' . $this->session->data['token'], 'SSL');
		$data['add'] = $this->url->link('font/category/insert', 'token=' . $this->session->data['token'] , 'SSL');
		...
		$this->response->setOutput($this->load->view('font/category_list.tpl',$data));
	...
	private function getForm() {
		...
		if (!isset($this->request->get['id_category'])) {
			$data['action'] = $this->url->link('font/category/insert', 'token=' . $this->session->data['token'], 'SSL');
		} else {
			$data['action'] = $this->url->link('font/category/update', 'token=' . $this->session->data['token'] . '&id_category=' . $this->request->get['id_category'], 'SSL');
		}
		
		$data['cancel'] = $this->url->link('font/category', 'token=' . $this->session->data['token'], 'SSL');
		...
		$template = 'font/category_form.tpl';
	...
	private function validateDelete() {
  	...
  	public function category_tab() {
		...
		$template = 'font/category_tab.tpl';
		
		return array(
			'id' => 'tab-categories',
			'label' => $this->language->get('text_tab_label'),
