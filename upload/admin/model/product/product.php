			...
			foreach($data['color_size'] as $id_product_color=>$sizes)
			{
				if(isset($validColors[$id_product_color]))
				{
					if($product_option_id_color) {
						$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_value SET product_option_id = '" . (int)$product_option_id_color . "', product_id = '" . $product_id . "', option_id = '" . (int)$this->config->get('opentshirts_setting_product_color_option_id') . "', option_value_id = '" . (int)$validColors[$id_product_color]['option_value_id']. "', quantity = '0', subtract = '0', price = '0', price_prefix = '+', points = '0', points_prefix = '+', weight = '0', weight_prefix = '0'");
					}
					...
					foreach($sizes as $id_product_size=>$value)
					{
						if($product_option_id_size) {
							if(!in_array($id_product_size, $saved_sizes)) {
								$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_value SET product_option_id = '" . (int)$product_option_id_size . "', product_id = '" . $product_id . "', option_id = '" . (int)$this->config->get('opentshirts_setting_product_size_option_id') . "', option_value_id = '" . (int)$validSizes[$id_product_size]['option_value_id'] . "', quantity = '0', subtract = '0', price = '0', price_prefix = '+', points = '0', points_prefix = '+', weight = '0', weight_prefix = '0'");
